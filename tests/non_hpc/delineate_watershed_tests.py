...
""" This is an example usage of the 'delineate_watershed' HydroDS client api using outlet X and Y coordinates"""
...
response_data = hds.subset_raster(left=-111.97, top=42.11, right=-111.35, bottom=41.66, input_raster='nedWesternUS.tif',
                                  output_raster='subset_dem_logan_test.tif')
...
try:
    response_data = hds.delineate_watershed(input_raster_url_path=output_proj_raster_url, outlet_point_x=-111.787,
                                            outlet_point_y=41.742, epsg_code=2152, threshold=60000,
                                            output_raster='logan_ws_taudem.tif',
