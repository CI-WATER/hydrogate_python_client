...
""" This is an example usage of the 'netcdf_rename_variable' HydroDS client api """
...
try:
    ...
    response_data = hds.netcdf_rename_variable(input_netcdf_url_path=input_netcdf_url,
                                               input_variable_name='Band1', output_variable_name='Band2',
